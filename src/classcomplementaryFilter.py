...
class complementaryFilter:
    '''
    a modified version of the complementary filter found here : https://github.com/ccny-ros-pkg/imu_tools/tree/indigo/imu_complementary_filter
    uses accel and gyro readings to find the orientation of the sensor wrt gravity.
    uses quaternions
    '''
    ...
    def execute(self,accX, accY, accZ, gyrX, gyrY,gyrZ,
        ...
        for i in range(len(iteratorType)):
            ...
            #currently not used, so a static gain is assigned.
            gain = self.gain_acc_
    ...
    def solveRotationMatrix(self,neworienta, neworientb, neworientc, neworientd,time):
        '''
        create rot matrix from quaternions
        '''
    ...
    def solveOrientation(self,xsensstackedMatrix,hlstackedMatrix,xsensFPS):
        '''
        stable region extrinsic rotation matrix alignment
        '''
    ...
    def XsensOnHL(self,coarseAligned_xsensGyrX, coarseAligned_xsensGyrY, coarseAligned_xsensGyrZ,
        ...
        '''
        transfers the xsens values on HL for cross-correlation and further post processing
        '''
