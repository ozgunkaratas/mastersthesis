...
##################################################################################################################   
    ...
    #some manual snipping from the hexapod readings bc i had to manually start all of the devices
    accX = accX[17220:-1600]        
    accY = accY[17220:-1600]                
    accZ = accZ[17220:-1600]                
    gyrX = gyrX[17220:-1600]                
    gyrY = gyrY[17220:-1600]                
    gyrZ = gyrZ[17220:-1600]        
    utcTime = utcTime[17220:-1600] 
    rosTime = rosTime[17220:-1600] 


    interp_hlAccX = interp_hlAccX[2640:-235]     
    interp_hlAccY = interp_hlAccY[2640:-235]     
    interp_hlAccZ = interp_hlAccZ[2640:-235]     
    interp_hlGyrX = interp_hlGyrX[2640:-235]     
    interp_hlGyrY = interp_hlGyrY[2640:-235]     
    interp_hlGyrZ = interp_hlGyrZ[2640:-235]     
    h_a_time_experiment_aug = h_a_time_experiment_aug[2640:-235] 
    h_g_time_experiment_aug = h_g_time_experiment_aug[2640:-235]  
    queryPointsGyr = queryPointsGyr[2640:-235]
    queryPointsAcc = queryPointsAcc[2640:-235]
######################################  COARSE ALIGNMENT 
